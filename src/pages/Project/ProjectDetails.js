...
const ProjectDetails = () => {
  ...
  // Close full-screen gallery modal
  ...
  return (
    <div className="project-details-container">
      ...
      <div className="project-content-wrapper">
        ...
        {project.images && project.images[0] && (
          ...
          >
            ...
            <div className="hero-overlay">
              ...
              <div className="project-type-badge">{project.projectType}</div>
              <div className="hero-click-hint">
                <MdOutlineZoomOutMap /> Click image to view full screen
              </div>
            </div>
          </div>
        )}
        ...
        <div className="details-section" data-aos="fade-up">
          ...
          <div className="details-grid">
            <div className="detail-card">
              ...
              <div>
                <h3>Project Type</h3>
                <p>{project.projectType || "Residential"}</p>
              </div>
            </div>
        ...
        {project.images && project.images.length > 1 && (
          <div className="gallery-section" data-aos="fade-up">
            <h2 className="section-title">
              <FaCamera className="title-icon" /> Project Gallery
            </h2>
            <p className="section-subtitle">Click on any image to view in full screen</p>
        ...
        {project.amenities && project.amenities.length > 0 && (
          <div className="amenities-section" data-aos="fade-up">
            ...
            <p className="section-subtitle">Premium facilities and amenities included</p>
            
            <div className="amenities-grid">
              {project.amenities.map((amenity, index) => (
                <div className="amenity-item" key={index} data-aos="zoom-in">
      ...
      {/* Full Screen Image Gallery Modal (WhatsApp Style) */}
